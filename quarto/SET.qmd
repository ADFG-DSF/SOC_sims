...
#| fig.height: 6
#| fig.width: 8
#| fig.cap: "Simulated escapments for stocks with ln(\u03B1) = 1.5 and \u03B3 = 0.5. Light grey lines show the simulated escapement for each replicate simulation, the thick black line is the medain, the solid red line is the escapment goal lower bound and the dashed red line is the theoretical SET."
rep_scenarios_gp %>%
