...
In the previous documents I suggested definitions for yield and management concern which clarify the reason ADF&G would be concerned for each type listing. In the case of a yield concern we would be worried about overharvest whereas during a management concern we would be worried about having lost our ability to manage the stock. On the surface conservation concern is considerably more clear... we are worried about the stocks ability to propagate itself. It also seems easy to assess... wait till you are in a management concern, monitor R/S and declare an SET when R/S dips below 1. The issue arises because according to the spawner-recruit theory we use to manage salmon populations in Alaska (i.e the Ricker curve) we will never observe this condition.
...
![](images/clipboard-1606042173.png)
